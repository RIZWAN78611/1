    ...
    <section id="gallery" className="py-24 bg-white dark:bg-slate-950">
      <div className="container px-6 mx-auto">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          <h2 className="mb-4 text-4xl font-bold text-slate-900 dark:text-white md:text-5xl">Our Gallery</h2>
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-bold transition-all ${
                  filter === cat
                    ? "bg-blue-600 text-slate-900 dark:text-white shadow-lg shadow-blue-600/20"
                    : "bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-slate-800"
                }`}
              >
                {cat}
              </button>
