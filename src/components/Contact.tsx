            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-slate-500 dark:text-slate-500 uppercase font-bold">Email</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-slate-500 dark:text-slate-500 uppercase font-bold">Phone</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-slate-500 dark:text-slate-500 uppercase font-bold">Location</p>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg p-3 text-slate-900 dark:text-white focus:border-blue-600 outline-none transition-colors"
                />
                <input
                  type="email"
              ...
              <input
                type="text"
                placeholder="Subject"
                className="w-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg p-3 text-slate-900 dark:text-white focus:border-blue-600 outline-none transition-colors"
              />
              <textarea
                placeholder="Message"
                rows={4}
