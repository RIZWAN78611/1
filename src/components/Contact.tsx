      ...
      <div className="container px-6 mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-600 dark:text-slate-400 text-lg mb-12">
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-600 dark:text-slate-600 dark:text-slate-400 ml-1">Full Name</label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-600 dark:text-slate-600 dark:text-slate-400 ml-1">Email Address</label>
                  <input
                    type="email"
                    className="w-full px-6 py-4 bg-white dark:bg-slate-950 border border-slate-800 rounded-xl focus:outline-none focus:border-blue-500 text-slate-900 dark:text-white transition-colors"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-600 dark:text-slate-600 dark:text-slate-400 ml-1">Subject</label>
                <input
                  type="text"
                  className="w-full px-6 py-4 bg-white dark:bg-slate-950 border border-slate-800 rounded-xl focus:outline-none focus:border-blue-500 text-slate-900 dark:text-white transition-colors"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-600 dark:text-slate-600 dark:text-slate-400 ml-1">Message</label>
                <textarea
                  rows={4}
