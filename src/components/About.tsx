      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-8">Committed to Engineering Excellence</h2>
              ...
              {specs.map((spec, i) => (
                ...
                >
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center group-hover:bg-blue-500 transition-colors">
                    <CheckCircle2 className="h-5 w-5 text-blue-500 group-hover:text-slate-900 dark:text-white transition-colors" />
                  </div>
                  <span className="text-slate-300 group-hover:text-slate-900 dark:text-white transition-colors">{spec}</span>
                </motion.div>
              ))}
            </div>
          ...
          >
            <div className="aspect-square bg-slate-900 rounded-3xl overflow-hidden border border-slate-800 shadow-2xl relative group">
              ...
              <div className="relative p-12 flex flex-col justify-end h-full z-10">
                <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600 text-slate-900 dark:text-white shadow-xl">
